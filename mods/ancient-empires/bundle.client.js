// Ancient Empires — Tier-B bundle (CLIENT only). Layers images over Tier-A. Generated by create-mod.
// NEVER import from Game.js / server.js / the sim / tests (pulls the keyArt PNG + globe lib).
import { ancientEmpiresData } from './bundle.data';
...
export default ancientEmpiresClient;

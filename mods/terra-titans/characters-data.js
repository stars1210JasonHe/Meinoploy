...
export const CHARACTERS_DATA = [
  ...
  },
  {
    ...
    name: 'Qin Shi Huang',
    title: 'First Emperor',
    stats: { capital: 8, luck: 3, negotiation: 5, charisma: 4, tech: 7, stamina: 7 },
    passive: {
      id: 'pioneer',
      name: 'Great Works',
      description: 'Property upgrade cost -20%, funding monumental construction.',
    },
    color: '#212121',
  },
  {
    id: 'wu-zetian',
    name: 'Wu Zetian',
    title: 'The Only Empress',
    stats: { capital: 6, luck: 5, negotiation: 9, charisma: 6, tech: 4, stamina: 4 },
    passive: {
      id: 'merchant',
      name: 'Statecraft',
